...
(function () {
  ...
  GeminiScrollbar.prototype.create = function create() {
    ...
    if (this.createElements === true) {
      ...
      this._thumbHorizontalElement =
        this._scrollbarHorizontalElement.querySelector("." + CLASSNAMES.thumb);
    }
  ...
  GeminiScrollbar.prototype._createResizeTrigger =
  ...
  GeminiScrollbar.prototype._clickVerticalTrackHandler =
  ...
  GeminiScrollbar.prototype._clickHorizontalTrackHandler =
    function _clickHorizontalTrackHandler(e) {
      if (e.target !== e.currentTarget) {
        return;
      }
  ...
  GeminiScrollbar.prototype._clickVerticalThumbHandler =
    function _clickVerticalThumbHandler(e) {
      this._startDrag(e);
      this._prevPageY = this._thumbSizeY - e.offsetY;
    };

  GeminiScrollbar.prototype._clickHorizontalThumbHandler =
    function _clickHorizontalThumbHandler(e) {
      this._startDrag(e);
  ...
  GeminiScrollbar.prototype._mouseUpDocumentHandler =
    function _mouseUpDocumentHandler() {
      this._cursorDown = false;
  ...
  GeminiScrollbar.prototype._mouseMoveDocumentHandler =
    function _mouseMoveDocumentHandler(e) {
      ...
      if (this._prevPageY) {
        offset =
          e.clientY -
          this._scrollbarVerticalElement.getBoundingClientRect().top;
